...
public class DateUtil {
	...
	public static long getDateDeff(Date startDate, Date endDate) {
		long intValue = 0;
		startDate = DateUtil.strToDate(DateUtil.dateToStr(startDate,
				"yyyy-MM-dd"), "yyyy-MM-dd");
		endDate = DateUtil.strToDate(DateUtil.dateToStr(endDate,
				"yyyy-MM-dd"), "yyyy-MM-dd");
	...
	//	System.out.println(org.apache.commons.lang3.StringUtils.substring("0123456789", 0, 1));
