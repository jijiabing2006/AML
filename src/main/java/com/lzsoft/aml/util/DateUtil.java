...
public class DateUtil {
	...
	public static long getDateDeff(Date startDate, Date endDate) {
		long intValue = 0;
		startDate = DateUtil.strToDate(
				DateUtil.dateToStr(startDate, "yyyy-MM-dd"), "yyyy-MM-dd");
		endDate = DateUtil.strToDate(DateUtil.dateToStr(endDate, "yyyy-MM-dd"),
				"yyyy-MM-dd");
	...
	public static long getMonth(Date startdate, Date enddate) {
		...
		return getMonthByDay(startdate, enddate);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		// System.out.println(strToDate("121***", "yyMMdd"));
		...
		System.out.println(getDayInMonthByDate(getLastDayByMonth(DateUtil
				.strToDate("20120229", "yyyyMMdd"))));

		// System.out.println(getMonth(DateUtil.strToDate("20130131",
		// "yyyyMMdd"), DateUtil.strToDate("20130228", "yyyyMMdd")));
	}

	public static long calculateMonth(Date startdate, Date enddate) {
		int flag = 1;
		...
		long month = (endyear - startyear) * 12;
