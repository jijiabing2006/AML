...
public abstract class BaseJpaDao implements DAO {
	...
	public <T extends BaseEO> Object getMaxByWhere(Class<T> entityClass,String maxFieldname,
			String whereql, Object[] queryParams) {
		StringBuffer sf_QL = new StringBuffer("SELECT Max(").append(maxFieldname).append(") FROM ")
				.append(sqlBuilder.getEntityName(entityClass)).append(
						" o WHERE 1=1 ");
	...
	public <T extends BaseEO> List<Object> getFieldValueByWhere(Class<T> entityClass,String fieldname,
			String whereql, Object[] queryParams){
	...
	public <T extends BaseEO> List<T> queryByWhere(Class<T> entityClass,
		...
		String entityname = sqlBuilder.getEntityName(entityClass);
//		String wheresql=sqlBuilder.generateQuerySql(queryClass);
		Query query = getEntityManager().createQuery(
				"SELECT o FROM "
						+ entityname
						+ " o "
	...
	@Override
    public List getListBySql(String  sql, String className) {
           Query query = getEntityManager().createNativeQuery(sql, className);
           query.setHint("org.hibernate.cacheable", true);
           return query.getResultList();
    }
    ...
    @Override
    public Object getSingleBySql(String  sql,Object[] queryParams) {
    	Query query = getEntityManager().createNativeQuery(sql);
    	setQueryParams(query, queryParams);
		query.setHint("org.hibernate.cacheable", true);
    	return  query.getSingleResult();
